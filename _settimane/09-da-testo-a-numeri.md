...
Lab *recensioni simili*: data una recensione, trovare le cinque più vicine nel dataset testuale del proprio settore. Poi classificazione delle recensioni (positiva/negativa) con la random forest della settimana 8 addestrata sugli embeddings: la foresta non sa che sono testi.
...
La foresta che classifica gli embeddings è nella [settimana 8](08-random-forest). Nella [settimana 10](10-modello-di-linguaggio) il modello che produce gli embeddings genera anche testo, un token alla volta.
