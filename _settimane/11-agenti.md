...
Un agente che risponde a domande di business sul dataset del gruppo chiamando funzioni pandas («quanti clienti in churn nel segmento X?»): è la componente agente del progetto finale. **RAG minimo**: embeddings delle lezioni del corso (settimana 9), recupero dei paragrafi più vicini alla domanda, risposta: in venti righe costruite il tutor che avete usato tutto il semestre. Un agente che traduce un lab intero da R a Python. Sfida: valutare un agente con una batteria di casi, esattamente come si valutavano i lab.

## Per approfondire

Le funzioni che diventano strumenti sono nella [settimana 3](03-ripetere-e-astrarre); la chiamata API e il JSON nella [settimana 10](10-modello-di-linguaggio). La [settimana 12](12-chiusura) chiude il cerchio.
