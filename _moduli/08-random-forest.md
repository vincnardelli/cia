...
La pipeline scikit-learn passo per passo: separare X e y, dividere train e test, addestrare, valutare con la confusion matrix del modulo 6. *Churn* con random forest a confronto con l'albero singolo. Poi lo stesso confronto su un dataset del proprio settore.
